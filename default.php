...
<body>
    ...
    <nav class="navMobile">
        ...
        <ul>
            ...
            <li><a onclick="fecharNav()" href="">Volantes</a></li>
            <li><a onclick="fecharNav()" href="">Laterais</a></li>
            <li><a onclick="fecharNav()" href="">Paineís</a></li>
        ...
        <hr>
            ...
            <div class="texto-sobreR" >
                <h1 class="title">SOBRE NÓS</h1>
                    <p>Acreditamos que seu carro merece mais do que apenas um revestimento. Oferecemos soluções premium em revestimentos automotivos desenvolvidos com paixão, excelência,  inovação e  proporcionando a estética da proteção duradoura ao seu veículo.
                    </p>
                    </div>
                    <div class="listraTR1">
                    </div>
...
<section class="sobre-nos" id="sobre-nos3">
    <div class="class-sobre-nos3">
        ...
        <div class="texto-sobreR" id="VisaoeValores">
            ...
            <p>Ser a referência no mercado de revestimentos automotivos, inovando constantemente em tecnologias e design, estabelecendo<br> parcerias duradouras com clientes e fornecedores.</p>
            <br>
            <br>
    ...
    <section class="desc-zen-section">
				...
				<div class="quadradinhos">
					...
					<h2>LATERAIS</h2>
					<p>Revestimento do painel de couro de alta qualidade oferece diversos benefícios que o tornam uma escolha superior em relação aos painéis tradicionais de tecido ou plástico, tornando-o mais atraente em sua conservação.</p>
				...
				<div class="quadradinhos">
					...
					<h2>PAINEÍS</h2>
					<p>Eleve o nível de estilo do seu veículo com a aplicação da logo da sua marca ou símbolo pessoal nos bancos de couro. Oferecemos duas opções de personalização para atender às suas necessidades.</p>
					<br>
   ...
   <!-- BOTAO WHATSAPP -->
    ...
    <section class="duvidas-drop">
        <div class="listDrop">
            ...
            <li id="DropDinheiro">Dinheiro ▼</li>
                <ul class="dropdown">
